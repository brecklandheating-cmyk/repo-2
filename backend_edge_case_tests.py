...
class BrecklandHeatingEdgeCaseTests:
    ...
    def test_unauthorized_access(self):
        ...
        if not success and ("Not authenticated" in str(result) or "401" in str(result) or "403" in str(result)):
    ...
    def test_convert_already_converted_estimate(self):
        ...
        if not success and ("Estimate already converted" in str(result2) or "400" in str(result2)):
